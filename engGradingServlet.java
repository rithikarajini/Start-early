...
@WebServlet("/engGradingServlet")
public class engGradingServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String[] userAnswers = {
                ...
                request.getParameter("q7_1"),
                request.getParameter("q7_2"),
                request.getParameter("q7_3")
            };

            String[] correctAnswers = { "Apple", "Fish", "Lion", "C", "I", "P", "Animal", "Fruit", "Animal" };
            ...
            try (Connection conn = DriverManager.getConnection(jdbcURL, dbUser, dbPassword)) {
                ...
                try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                    ...
                    response.sendRedirect("results.html?score=" + score + "&correct=" + correctList + "&wrong=" + wrongList);
                }
            }
