...
@WebServlet("/tamGradingServlet")
public class tamGradingServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String jdbcURL = "jdbc:mysql://localhost:3306/start_early?useUnicode=true&characterEncoding=UTF-8";
        String dbUser = "root";
        String dbPassword = "Rithika@14";
        request.setCharacterEncoding("UTF-8");  // Ensures input is read in UTF-8
        ...
        try {
            ...
            String[] correctAnswers = { "ஆடு", "இலை", "அ", "உ", "Father", "mother" };
            ...
            try (Connection conn = DriverManager.getConnection(jdbcURL, dbUser, dbPassword)) {
                ...
                try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                    ...
                    String encodedCorrect = URLEncoder.encode(correctList.toString(), "UTF-8");
                    String encodedWrong = URLEncoder.encode(wrongList.toString(), "UTF-8");
                    // Redirect to the result page
                    response.sendRedirect("result.html?score=" + score + "&correct=" + encodedCorrect + "&wrong=" + encodedWrong);
                }
            }
